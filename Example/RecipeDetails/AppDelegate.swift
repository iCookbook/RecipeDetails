...
extension AppDelegate {
    var recipe: Recipe {
        Recipe(
            ...
            healthLabels: Optional(["Gluten-Free", "Wheat-Free", "Egg-Free", "Peanut-Free", "Tree-Nut-Free", "Soy-Free", "Fish-Free", "Shellfish-Free", "Pork-Free", "Red-Meat-Free", "Crustacean-Free", "Celery-Free", "Mustard-Free", "Sesame-Free", "Lupine-Free", "Mollusk-Free", "Alcohol-Free"]),
            cautions: Optional(["Sulfites"]),
            ingredientLines: Optional(["½ cup (1 stick) unsalted butter", "5 cups yellow onions, chopped", "½ teaspoon salt", "½ teaspoon coarse ground black pepper", "¼ teaspoons crushed red pepper flakes", "3 tablespoons granulated sugar", "3 tablespoons apple cider vinegar", "1 tablespoon fresh lemon juice", "2 cups chopped red bell pepper", "1 cup chicken stock"]),
